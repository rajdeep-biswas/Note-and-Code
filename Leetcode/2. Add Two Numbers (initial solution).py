...
class Solution:
    ...
    The second sitting was in February 2022 where I have written this unreadable monstrosity solution that doesn't even work (1341 / 1568 testcases passed), I didn't even try to read it. I also seem to have disliked the problem on Leetcode lol
